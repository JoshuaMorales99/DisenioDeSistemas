# <ins>**Vuelos y Aeropuertos**</ins>
## 📌 Contexto general
![Vuelos y Aeropuertos](Vuelos.jpg)
...
9. La cantidad de vuelos que realizó una tripulación en un período de tiempo determinado (en meses).
